...
const char *wifi_network_ssid     = "Tp_ling";   /*Replace with Your own network SSID*/
const char *wifi_network_password = "hromasova"; /*Replace with Your own network PASSWORD*/
